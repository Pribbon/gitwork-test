...
define(['jquery','underscore','backbone'],function($,_,backdone){
    ...
    var w = backdone.Router.extend({
        ...
        home:function(){
            ...
            require(['text!./home/home.html','./home/js/home','./home/js/crazyShop','public/js/index','public/js/localStorage','text!./home/jssdk.php','text!./public/wx.php'],function(tpl,ctrl,req,res,storage) {
